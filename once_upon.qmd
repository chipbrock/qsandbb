...
>  ℹ️ README: A longer introduction to Quarks, Spacetime, and the Big Bang (remember that I affectionately refer to as “**QS&BB**”)describing how particle physics and cosmology have evolved in only a few generations. Plus, what we'll care about!
...
::: {style="width:60%; margin: auto;"}
![This is the Hubble eXtreme Deep Field, a compilation of hundreds of days of observation of a single dime-sized patch on the sky in the constellation, Fornax. Every spot is a galaxy, some nearby and some at the edge of our ability to see.](./images/ultraextreme.png)
:::
